  ...
  return (
    ...
    >
      <div className="w-full rounded-xl bg-card py-4 pr-4">
        <h3 className="pl-4 mb-4 text-sm font-semibold text-muted-foreground">
          {t(`measurements.${selectedMetric}`)}
        </h3>
        <div className="h-48 w-full min-w-0">
          <ResponsiveContainer className="h-48 w-full min-w-0">
            <LineChart
              key={selectedMetric}
              data={chartData}
