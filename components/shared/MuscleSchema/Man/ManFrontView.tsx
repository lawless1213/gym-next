...
export default function ManFrontView({selectedMuscles}: MuscleViewProps) {
  ...
  return (
    <>
      <svg
        ...
        <g
          id="quads"
          className={`${isSelected("quads") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle`}>
          <path
        ...
        <g
          id="abdominals"
          className={`${isSelected("abdominals") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle`}>
          <path
        ...
        <g
          id="obliques"
          className={`${isSelected("obliques") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle`}>
          <path
        ...
        <g
          id="biceps"
          className={`${isSelected("biceps") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle`}>
          <path
        ...
        <g
          id="front-shoulders"
          className={`${isSelected("front-shoulders") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle`}>
          <path
        ...
        <g
          id="chest"
          className={`${isSelected("chest") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle`}>
          <path
