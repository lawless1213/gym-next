...
export default function ManFrontView({selectedMuscles, onToggleMuscle}: MuscleViewProps) {
    ...
    <>
      <svg
        ...
        <g
          ...
          className={`${isSelected("quads") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle cursor-pointer`}>
          <path
        ...
        <g
          id="obliques"
          onClick={() => onToggleMuscle?.("obliques")}
          className={`${isSelected("obliques") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle cursor-pointer`}>
          <path
        ...
        <g
          id="abdominals"
          onClick={() => onToggleMuscle?.("abdominals")}
          className={`${isSelected("abdominals") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle cursor-pointer`}>
          <path
        ...
        <g
          ...
          className={`${isSelected("biceps") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle cursor-pointer`}>
          <path
          ...
          <path
            ...
            strokeWidth="3.58"></path>
        </g>
        <g
          id="chest"
          onClick={() => onToggleMuscle?.("chest")}
          className={`${isSelected("chest") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle cursor-pointer`}>
          <path
        ...
        <g
          id="front-shoulders"
          onClick={() => onToggleMuscle?.("front-shoulders")}
          className={`${isSelected("front-shoulders") ? "text-muscle" : "text-background"} bodymap text-background active:text-muscle lg:hover:text-muscle cursor-pointer`}>
          <path
