...
const navLinks: NavItem[] = [
  ...
  { link: '/stats', label: 'stats', icon: <IconChartBar className="size-6" />, loginRequired: true, subscribeRequired: true },
  { link: '/settings', label: 'settings', icon: <IconSettings className="size-6" />, loginRequired: true },
  { modal: 'ai', label: 'ai', icon: <IconAi className="size-10" />, loginRequired: true, verifyRequired: true , subscribeRequired: true},
];
